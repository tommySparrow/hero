...
import com.house.hero.common.constants.NumEnum;
...
public class CookieUtils {
    ...
    private static void doSetCookie(HttpServletRequest request, HttpServletResponse response, String cookieName, String cookieValue, int cookieMaxage, boolean isEncode) {
        try {
            ...
            if (cookieMaxage > NumEnum.ZERO.getNum()) {
    ...
    private static String getDomainName(HttpServletRequest request) {
        ...
        if (StringUtils.isEmpty(serverName)) {
            ...
            serverName = serverName.substring(NumEnum.SEVEN.getNum());

            String regex = "/";
            String[] strings = serverName.split(regex);
            serverName = strings[0];
            final String[] domains = serverName.split("\\.");
            int len = domains.length;
            if (len > NumEnum.THREE.getNum()) {
                // www.xxx.com.cn
                domainName = "." + domains[len - 3] + "." + domains[len - 2] + "." + domains[len - 1];
            } else if (len > NumEnum.TWO.getNum()) {
                // xxx.com or xxx.cn
        ...
        String a = ":";
        if (domainName.indexOf(a) > NumEnum.ZERO.getNum()) {
